...
class DisableBiometricPage extends StatefulWidget {
  const DisableBiometricPage({super.key, required this.session});

  final AuthSession session;

  @override
  State<DisableBiometricPage> createState() => _DisableBiometricPageState();
}

class _DisableBiometricPageState extends State<DisableBiometricPage> {
  ...
  Future<void> _submit() async {
    ...
    try {
      final ok = await sl<DisableBiometric>()(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Désactiver la biométrie')),
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Text(
                'Saisissez votre code PIN pour désactiver le déverrouillage '
                'par empreinte.',
